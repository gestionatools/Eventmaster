      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-slate-800 font-semibold">Nueva Convocatoria Especial FIN</h2>
              <p className="text-slate-400 text-xs">Evento fuera del plan estándar</p>
            </div>
          </div>
        ...
        <div className="p-5 space-y-4">
          {/* Nombre */}
          <div>
            <label className="text-slate-400 text-xs mb-1 block">Nombre de la convocatoria</label>
            <input
              type="text"
              value={convocatoria}
        ...
        <div className="flex gap-3 p-5 border-t border-slate-200">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-yellow-500 text-white border border-yellow-500 hover:bg-yellow-600 transition-all disabled:opacity-50"
          >
            {saving ? (
